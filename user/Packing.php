...
// Fetch user purchases with status 'Packing'
$query = "SELECT * FROM order_items WHERE user_id = :user_id AND status = 'Packing' ORDER BY order_date DESC";
...
<body class="bg-slate-100">
    ...
    <main class="p-6">
        <div class="max-w-5xl mx-auto bg-white rounded shadow-lg mt-10 p-4">
            ...
            <ul class="steps mb-4">
    <li class="step step-primary cursor-pointer" onclick="navigateTo('packing.php')">Packing</li>
